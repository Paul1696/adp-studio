...
export function StepProjet({ projects, value, onChange }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {active.length === 0 ? (
        <p className="text-[14px] text-adp-muted">Aucun projet disponible. Créez un projet avant de lancer une mission.</p>
      ) : (
